          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="rounded-3xl border border-sky-100 bg-white p-6 shadow-soft">
              ...
              <div className="mt-2 text-sm text-slate-600 leading-relaxed">
                Тази страница е предназначена за управление на основните данни за профила.
                Име и телефон са видими за домоуправителя при процеса на одобрение и при комуникация във входа.
                Имейлът е идентификатор за вход и се използва за потвърждение и възстановяване на парола.
              </div>
            ...
            <div className="rounded-3xl border border-sky-100 bg-white p-6 shadow-soft">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div>
                  ...
                  <input
                    className="w-full border rounded-2xl px-4 py-3 bg-slate-50"
                    value={user.email || ""}
                    disabled
                  />
                </div>
                ...
                <button
                  onClick={save}
                  disabled={loading}
                  className="w-full rounded-2xl px-4 py-3 text-sm font-semibold bg-sky-600 text-white hover:bg-sky-700 disabled:opacity-60"
                >
            ...
            <div className="rounded-3xl border border-sky-100 bg-white p-6 shadow-soft">
              ...
              <div className="mt-3 text-sm text-slate-700">
                Статус:{" "}
                {emailVerified ? (
                  <b className="text-green-700">Потвърден</b>
                ) : (
                  <b className="text-yellow-700">Непотвърден</b>
                )}
              </div>
              ...
              {!emailVerified ? (
                <>
                  ...
                  <button
                    ...
                    className="mt-4 w-full rounded-2xl px-4 py-3 text-sm font-semibold border border-sky-200 text-sky-700 hover:bg-sky-50 disabled:opacity-60"
                  >
            ...
            <div className="rounded-3xl border border-sky-100 bg-white p-6 shadow-soft">
              ...
              <div className="mt-4 space-y-2">
                <label className="block text-xs text-slate-500">Имейл</label>
                <input
                  className="w-full border rounded-2xl px-4 py-3"
                  value={pwEmail}
                ...
                <button
                  ...
                  disabled={pwLoading}
                  className="w-full rounded-2xl px-4 py-3 text-sm font-semibold bg-slate-900 text-white hover:bg-slate-800 disabled:opacity-60"
                >
